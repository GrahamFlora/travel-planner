...
const HK_MACAU_2026 = {
    ...
    days: [
        ...
        },
        {
            ...
            activities: [
                { id: 'a6_1', time: '07:00 - 08:30', title: 'Breakfast & Travel', type: 'travel', desc: 'Repeat bridge crossing to Macau.', details: '', image: 'https://images.unsplash.com/photo-1628522303038-d6556e87a2d3?auto=format&fit=crop&w=600&q=80' },
                { id: 'a6_2', time: '08:30 - 10:00', title: 'Macau Tower', type: 'attraction', desc: '338m high tower.', details: 'Observation deck views. Optional Skywalk/Bungee.', image: 'https://images.unsplash.com/photo-1577943260714-a95574384042?auto=format&fit=crop&w=600&q=80' },
                { id: 'a6_3', time: '10:00 - 13:00', title: 'Taipa Village', type: 'attraction', desc: 'Colorful houses, Taipa Houses Museum.', details: 'Pork chop buns at Tai Lei Loi Kei.', image: 'https://images.unsplash.com/photo-1573033501170-13d81b4f2c08?auto=format&fit=crop&w=600&q=80' },
                { id: 'a6_4', time: '13:00 - 14:30', title: 'Lunch: Macanese', type: 'food', desc: 'La Famiglia or Sab 8 Café.', details: 'Minchi and other local dishes.', image: 'https://images.unsplash.com/photo-1563507466359-1e285890832d?auto=format&fit=crop&w=600&q=80' },
                { id: 'a6_5', time: '14:30 - 17:00', title: 'Cotai Strip & Casinos', type: 'shopping', desc: 'Venetian, Parisian, City of Dreams.', details: 'Gondola rides, Eiffel Tower replica, shopping.', image: 'https://images.unsplash.com/photo-1623847844052-1c251d184043?auto=format&fit=crop&w=600&q=80' },
                { id: 'a6_6', time: '17:00 - 19:00', title: 'Dinner', type: 'food', desc: 'Macau Tower 360 Café or Cotai.', details: 'Revolving buffet or resort dining.', image: 'https://images.unsplash.com/photo-1550966871-3ed3c47e2ce2?auto=format&fit=crop&w=600&q=80' },
                { id: 'a6_7', time: '19:00 - 21:00', title: 'Return to Hong Kong', type: 'travel', desc: 'Shuttle bus back via HZMB.', details: '', image: 'https://images.unsplash.com/photo-1624362145327-142436f52230?auto=format&fit=crop&w=600&q=80' },
            ]
        },
        {
            id: 'd7', date: '2026-01-21', title: 'Day 7: Departure', summary: 'Last minute shopping and flight home.',
            activities: [
                { id: 'a7_1', time: '08:00 - 10:00', title: 'Breakfast & Pack', type: 'other', desc: 'Check out of Novotel Citygate.', details: 'Leave luggage at concierge.', image: 'https://images.unsplash.com/photo-1528696892704-5e1122852276?auto=format&fit=crop&w=600&q=80' },
                { id: 'a7_2', time: '10:00 - 13:00', title: 'Citygate Outlets', type: 'shopping', desc: 'Final shopping or promenade walk.', details: 'Lunch at The Next Chapter or The Tavern.', image: 'https://images.unsplash.com/photo-1555529733-0e670560f7e1?auto=format&fit=crop&w=600&q=80' },
                { id: 'a7_3', time: '13:00 - 15:00', title: 'Transfer to Airport', type: 'travel', desc: 'Hotel shuttle or taxi to HKIA.', details: 'Duty free shopping.', image: 'https://images.unsplash.com/photo-1569336415962-a4bd9f69cd83?auto=format&fit=crop&w=600&q=80' },
                { id: 'a7_4', time: '19:15 - 21:40', title: 'Flight to Manila', type: 'travel', desc: 'Flight back home.', details: 'Arrive 21:40.', image: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?auto=format&fit=crop&w=600&q=80' },
            ]
        }
    ]
};
...
export default function TravelApp() {
    ...
    // === NEW & IMPROVED FIREBASE EFFECTS (Replace both old ones) ===
    useEffect(() => {
        if (!auth) {
        ...
        const unsubscribe = onSnapshot(
            ...
            (snap) => {
                if (snap.exists()) {
                    ...
                    // Only write defaults ONCE when document truly doesn't exist
                    setDoc(userDocRef, {
